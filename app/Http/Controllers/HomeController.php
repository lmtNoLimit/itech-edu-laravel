    ...
    public function index()
    {
        ...
        $questions = [
            "Điều kiện tuyển sinh của Viện Đào tạo CNTT Quốc tế I-Tech là gì?",
                ...
                học
                có được giảm học phí không?",
                "Trong chương trình học có kỳ thực tập doanh nghiệp không? Em sẽ được tự
                chọn
                chỗ thực tập không hay nhà
                trường sắp xếp? Và thực tập có lương hay không?",
                "Tại Viện Đào tạo CNTT Quốc tế I-Tech, mỗi lớp có bao nhiêu sinh viên?",
                "Ngành Quản trị và bảo mật hệ thống mạng sinh viên học tại Viện Đào tạo
                CNTT
                Quốc tế I-Tech có điểm gì nổi
                bật so với những Trường khác?",
                "Học lập trình tại Viện Đào tạo CNTT Quốc tế I-Tech ra trường làm những
                công
                việc gì?",
