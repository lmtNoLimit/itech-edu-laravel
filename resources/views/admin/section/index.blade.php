...
<div class="container-fluid">
  ...
  <div class="row m-2 d-flex justify-content-end">
    <a href="/admin/section/create" class="btn btn-sm btn-success">
    ...
    <table class="table table-bordered table-hover">
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>{{$item->name}}</td>
          <td>
            <a href="/admin/section/{{$item->course_id}}/edit" class="btn btn-sm btn-info mr-1">
              Sửa
            </a>
              ...
              <div class="modal-dialog" role="document">
                <div class="modal-content">
                  ...
                  <div class="modal-footer border-0">
                    <form id="form" class="form-inline" action="/admin/section/{{$item->id}}" method="POST">
                      @csrf
                      @method('DELETE')
